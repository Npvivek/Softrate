! function(t) {
    ...
    1: function(t, e, n) {
        ...
        function C(t, e) {
            var n = "";
            return (e || v()).replace(/[?&]+([^=&]+)=([^&]*)/gi, (function(e, a, o) {
                a === t && (n = o)
            })), n
        }
    ...
    76: function(t, e, n) {
        ...
        Object(a.a)(),
            function(t) {
                ...
                function s(e) {
                    if ((!e.userTargetingConfig || !e.userTargetingConfig.pageRules || r.resolvePageRules(e.userTargetingConfig.pageRules)) && (!(e.userTargetingConfig && e.userTargetingConfig.visitorRules && e.userTargetingConfig.visitorRules.length) || r.resolveVisitorRules(e.userTargetingConfig.visitorRules))) {
                        if (e.userTargetingConfig && e.userTargetingConfig.dateConditions) {
                            var n = e.userTargetingConfig.dateConditions;
                            if (!r.resolveDateRules(n, e.config.timezone)) return
                        }
                        e.config.disabled || (void 0 !== document.getElementsByTagName("body")[0] ? t.CollectChatLauncher.init(e) : document.onreadystatechange = function() {
                            "interactive" === document.readyState && t.CollectChatLauncher.init(e)
                        })
                    }
                }
